...
def install_subparser(subparser):
    install_parser = subparser.add_parser('install', help='installs BeakerX SQL Kernel extensions')
...
def uninstall_subparser(subparser):
    uninstall_parser = subparser.add_parser('uninstall', help='uninstalls BeakerX SQL Kernel extensions')
...
def init_parser():
    ...
    parser.add_argument('--version', action='version', version=beakerx_sql.__version__)
